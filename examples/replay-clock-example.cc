...
void NodeRecvEvent(Ptr<ReplayClock> receiver,
                   Ptr<LocalClock> receiverPt,
                   Ptr<ReplayClock> piggybackedClock,
                   int64_t epsilon,
                   Time interval);

void
NodeSendEvent(Ptr<ReplayClock> sender,
              Ptr<ReplayClock> receiver,
              Ptr<LocalClock> senderPt,
              Ptr<LocalClock> receiverPt,
              int64_t epsilon,
              Time interval,
              Time delay)
...
void
NodeRecvEvent(Ptr<ReplayClock> receiver,
              Ptr<LocalClock> receiverPt,
              Ptr<ReplayClock> piggybackedClock,
              int64_t epsilon,
              Time interval)
